...
client_port=8080
client_ip="10.20.61.91"

conexion = CriptoConnection(8080)

menssage_out = conexion.awaitMessage()
print(menssage_out)
key=functions.generateKey(32)
conexion.sendMessage(client_ip,client_port,key)
salsa = salsa20(key)
...
while True:
    ...
    menssage=input()
    conexion.sendMessage(client_ip,client_port,salsa.cifrar(menssage.encode("utf-8")))
